...
## 1 selected in the current study because answer scale for participants in the study was 1 = 1-2 times per week symptoms severity, 2 = 3-4 times per week, 3 = daily, 4 = multiple times daily; consistent with other trauma measures
itq_calc <- itq_calc %>%
  mutate(
    itq_re_dx = case_when(
...
itq_complete <- itq_complete %>%
  select(id, itq_re_total, itq_av_total, itq_th_total, itq_fi_total, itq_ptsd_total) %>%
