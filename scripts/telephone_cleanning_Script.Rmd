...
dyadc  <- as.data.frame(lapply(dyadc , as.numeric))
...
dyadc_calc <-
  dyadc %>%
  mutate_all(~ifelse(. %in% c(-55, -77), NA, .)) %>%
  pct_miss_fun(
    id = c('id', 'dyadc_screener'),
    n_items = 32
  ) %>%
...
dyadc_complete <-
  dyadc_complete %>%
    subscale_create(
      total_only = FALSE,
      scale1 = c('das1', 'das2', 'das3', 'das4', 'das5',
      ...
      scale2 = c('das4', 'das6',
                 'das29', 'das30'),
      scale2_nitems = 4,
      scale3 = c('das16', 'das17', 'das18', 'das19', 'das20',
...
# we don't need averages, just totals
...
# mutate_at(vars(dyadc_screener :COUNTD5), as.numeric) %>%
  ...
  mutate(dyadc_con = das1+ das2+ das3+ das5+ das7+ das8+ das10+ das11+ das12+ das13+ das14+ das15,
         ...
         dyadc_satis = das16 + das17 + das18 + das19 + das20 + das21 + das22 + das23 + das31 + das32,
           #round(dyadc_satis * 100) / 100,
         dyadc_cohes = das24 + das25+  das26 + das27 + das28,
           #round(dyadc_cohes * 100) / 100,
         dyadc_total = das1 + das2+ das3+das4+das5+das6+das7+das8+das9+das10+das11+das12+das13+das14+das15+das16+das17+das18+das19+das20+das21+das22+das23+das24+das25+das26+das27+das28+das29+das30+das31+das32) %>%
