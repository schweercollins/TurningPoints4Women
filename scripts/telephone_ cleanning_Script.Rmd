...
cesd_missing <- cesd %>%
  ...
  select(id,
         c1:c24,
         #TODO: Maria/Shaina, I don't think we should include revers score here. if that is correct, Please remove these two line of comment. Otherwise Min will need edits calculation section.
         #c4_r:c16_r
         ) %>% 
  pct_miss_fun(
    id = 'id',
...
# TODO: Maria since we have developed period for combination of happened and witnessed, the following code is irrelevant, please confirm and removed. 
  #   mutate(
