...
Min's question: Should I rename the columns? what should I code NA to - they are not nesssely missing; should I identify NA manually (eg. if pcl1_1, pcl1_2, pcl1_3, pcl1_4 are all NAs)
```{r plc}
pcl <- tpw_raw %>%
...
pcl <- pcl %>%
  ...
  rename(pcl1_happen = pcl1_1) %>%
  rename(pcl1_witness = pcl1_2) %>%
  rename(pcl1_learn = pcl1_3) %>%
  rename(pcl1_0_5 = pcl1a_1) %>%
  rename(pcl1_)
