...
comb_long_custody <-
  ...
  pivot_longer(
    cols = matches('living_with$'),
    names_to = 'kiddo_living',
    values_to = 'kiddo_live_yesno'
  ) %>% 
  drop_na(custody, kiddo_live_yesno) %>% 
  arrange(id)
