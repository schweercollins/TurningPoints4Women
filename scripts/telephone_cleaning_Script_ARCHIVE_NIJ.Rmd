---
title: "Telephone Assessment Data Cleanning Script ARCHIVE NIJ"
author: "Min Zhang"
date: ""
...
```{r cts_calculations }
# We are not including compution for archive 
cts_complete <- cts %>%
  # reorder dataset 
...
# We are not include computation for Archive 
# finalize to add back in appropriate missing values
cts_pc_complete <- cts_pc %>%
  rename_all(tolower) %>%
