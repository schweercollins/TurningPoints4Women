...
bio_td <- bio_df %>% 
  ...
  select(family, ends_with("day"), ends_with("time"), bp1a, bp1b, bp2a, bp2b, height_measure:fev1c, fev1b,
...
bio_na <- bio_td %>% 
  ...
  mutate(cev2 = ifelse(cev1 == "0", "-55", cev2),
         ...
         across(c(hbc11a, hbc11b, hbc11c), ~ ifelse(hbc11 == "0", "-55", .)),
         across(c(hbc11b, hbc11c), ~ ifelse(hbc11a == "0", "-55", .)),
    ...
    select(family, starts_with("bp"), starts_with("bmi"), starts_with("wth"), pef1, pef2, pef3, pef4, pef5, pef6,
           pef_avg, pef_cal, pef_pal, starts_with("pulse"), starts_with("rhs"), starts_with("cev"), 
